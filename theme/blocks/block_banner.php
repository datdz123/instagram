...
?>
    <div <?php echo esc_attr($anchor); ?> class="<?php echo esc_attr($class_name); ?>">
        <section class="section-main">
            <nav class="category-custom">
                <div class="category__element"><a href="/video"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                ...
                <div class="category__element"><a href="/photo"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                ...
                <div class="category__element"><a href="/reels"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                            <g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3">
                ...
                <div class="category__element"><a href="/story"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                            <g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3">
                ...
                <div class="category__element"><a href="/igtv"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                            <g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3">
                                <path d="M12.76 3.482a1.58 1.58 0 0 1 1.58 1.58M13.55 1.111a3.16 3.16 0 0 1 3.16 3.16M14.34 7.433v3.95a1.58 1.58 0 0 1-1.58 1.58H3.278a1.58 1.58 0 0 1-1.58-1.58v-6.32a1.58 1.58 0 0 1 1.58-1.581h7.112M4.858 15.333h6.322"></path>
                            </g>
                        </svg> Igtv </a></div>
                <div class="category__element"><a href="/carousel"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                            <g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3">
                                <path d="M13 15H5c-.265 0-.52-.152-.707-.423-.188-.27-.293-.638-.293-1.021V3.444c0-.383.105-.75.293-1.02C4.481 2.151 4.735 2 5 2h8c.265 0 .52.152.707.423.188.271.293.638.293 1.021v10.111c0 .384-.105.751-.293 1.022-.188.27-.442.423-.707.423ZM3.5 4H2a.953.953 0 0 0-.707.325A1.177 1.177 0 0 0 1 5.111v7.778c0 .295.105.577.293.786A.952.952 0 0 0 2 14h1.5M14.5 4H16c.265 0 .52.117.707.325.188.209.293.491.293.786v7.778c0 .295-.105.577-.293.786A.953.953 0 0 1 16 14h-1.5"></path>
                            </g>
                        </svg> Carousel </a></div>
                    ...
                    <a href="/viewer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none">
                            <g stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                <path d="M.75 9s3-6 8.25-6 8.25 6 8.25 6-3 6-8.25 6S.75 9 .75 9Z"></path>
                                <path d="M9 11.25a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Z"></path>
                            </g>
                        </svg> Viewer</a>
                </div>
            </nav>
            <div class="section-main__content">
                <?php if (get_field('title')) : ?>
                    <h1 class="section-main__title"><?php the_field('title'); ?></h1>
                <?php endif; ?>
                <?php if (get_field('description')) : ?>
                    <p class="section-main__text"><?php the_field('description'); ?></p>
                <?php endif; ?>
            ...
            <form class="search-form" onsubmit="return false">
                <div class="search-form__field">
                    <label for="search-form-input" class="search-form__label">
                        <input oninput="handleInputChange()" onpaste="handleInputPaste(event)" type="text" id="search-form-input" placeholder="Insert instagram link here" class="search-form__input">
                    </label>
                    <div class="search-form__clipboard">
                        <button class="search-form__clipboard-paste" onclick="handlePasteButtonClick()" type="button">
                        ...
                        <button class="search-form__clipboard-clear" onclick="handleClearButtonClick()" style="display: none" type="reset">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <button class="search-form__button" onclick="handleSearchButtonClick()" type="submit">
                    Download
                </button>
            </form>
        ...
        <section class="search-result" style="display: none;"></section>
