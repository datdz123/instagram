	...
	<div class="container mx-auto">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
			...
			<g id="Layer_12 yellow-back-fig" data-name="Layer 12">
				...
				<rect class="instagram_404-1" x="492.21" y="920.64" width="249.8" height="8.39" rx="4.19"
					ry="4.19" />
				<path class="instagram_404-1"
				...
				<rect class="instagram_404-1" x="915.6" y="981.47" width="54.72" height="8.39" rx="4.19"
					ry="4.19" />
				<path class="instagram_404-1"
				...
				<rect class="instagram_404-1" x="997.06" y="981.47" width="78.11" height="8.39" rx="4.19"
					ry="4.19" />

				<g id="round-conf">
					<path class="instagram_404-1 circle c1"
					...
					<path class="instagram_404-1 circle c2"
					...
					<path class="instagram_404-1 circle c3"
					...
					<path class="instagram_404-1 circle c4"
					...
					<path class="instagram_404-1 circle c5"
					...
					<path class="instagram_404-1 circle c6"
			...
			<g id="fortyfour" data-name="Layer 2">
				<g class="four a">
					...
					<rect class="instagram_404-2" x="233.74" y="391.14" width="120.71" height="466.29"
						rx="57.1" ry="57.1" transform="translate(918.39 330.19) rotate(90)" />

					<rect class="instagram_404-3" x="333.83" y="475.1" width="120.71" height="396.88"
						rx="60.36" ry="60.36" />

					<rect class="instagram_404-3" x="197.13" y="122.89" width="120.71" height="604.75"
						rx="60.36" ry="60.36" transform="translate(290.49 -70.78) rotate(35)" />

				</g>
				<g class="four b">

					<rect class="instagram_404-2" x="1558.84" y="391.91" width="120.71" height="466.29"
						rx="57.1" ry="57.1" transform="translate(2244.26 -994.14) rotate(90)" />


					<rect class="instagram_404-3" x="1658.92" y="475.87" width="120.71" height="396.88"
						rx="60.36" ry="60.36" />

					<rect class="instagram_404-3" x="1522.22" y="123.66" width="120.71" height="604.75"
						rx="60.36" ry="60.36" transform="translate(530.57 -830.68) rotate(35)" />

				</g>
				<path class="instagram_404-3" id="ou"
			...
			<g id="cup" data-name="Layer 7">
				...
				<polygon class="instagram_404-5"
					points="1194.68 731.46 1157.04 694.24 1183.8 661.7 1226.91 704.32 1194.68 731.46" />
				<g class="instagram_404-10">
					<path class="instagram_404-8"
			...
			<g id="clock" data-name="Layer 8">
				...
				<circle class="instagram_404-5" cx="847.7" cy="247.59" r="74.66"
					transform="translate(-32.91 314.05) rotate(-20.6)" />
				<circle class="instagram_404-1" cx="847.7" cy="247.59" r="63.44"
					transform="translate(-32.91 314.05) rotate(-20.6)" />
				<rect class="instagram_404-3 clock-hand-1" x="845" y="189.5" width="6.04" height="58"
					rx="3.02" ry="3.02" />
				<rect class="instagram_404-3 clock-hand-2" x="845" y="209.5" width="6.04" height="38"
					rx="3.02" ry="3.02" transform="translate(1611.22 -230.4) rotate(130.4)" />
				<circle class="instagram_404-3" cx="847.7" cy="247.59"
			...
			<g id="box" data-name="Layer 9">
				...
				<path class="instagram_404-7"
					d="M588.28,420.26s3.44,5.2,5.19,8l43.1,68.48,158.81-100-43.1-68.48q-2.63-4.17-5.47-8Z">
				</path>
				<rect class="instagram_404-5" x="693.73" y="335.51" width="83.99" height="90.58"
			...
			<g id="bike" data-name="Layer 5">
				<path class="instagram_404-8 wheel"
				...
				<g>
					<rect class="instagram_404-1" x="871.39" y="693.37" width="12.87" height="53.21"
				...
				<g>
					<circle class="instagram_404-9" cx="1022.66" cy="599.55" r="11.57"
					...
					<circle class="instagram_404-11" cx="1027.9" cy="587.94" r="12.99"
