			...
			3026: (e, t, n) => {
								...
								switch (e.title) {
									case Nh:
										try {
											...
											this.isLoading = !1, this.stories = pf(e, m), this.stories.length ? this.mediaList = this.stories : (this.stories = null, console.log("Нет историй"), this.errorMessage = this.getLocalizedText("noStoriesMessage"), this.$mediaSearchController.analyticsTracker.trackError("No stories"))
										} catch (e) {
				...
				const xy = {
					ar: {
						...
						btnBack: "العودة",
						btnDownload: "تنزيل",
						btnDownloadOther: "تنزيل آخر",
						captchaLabel: "أدخل النص الذي تراه أعلاه",
						captchaIncorrectText: "النص غير صحيح",
						downloadFileReady: "الملف جاهز",
						downloadPage: "هذه هي صفحة التنزيل على موقعنا. نحن لا نخزن بياناتك أو نستضيف أي محتوى على خادمنا.",
						downloadPageAnon: "استخدم Anonyig لتنزيل أي فيديو أو صورة من إنستغرام إلى جهازك - مجاناً وآمناً وسريعاً ومجهولاً.",
						errorDefault: "حدث خطأ ما",
						errorLinkRequired: "اسم المستخدم أو الرابط مطلوب",
						errorLinkFormat: "تنسيق الرابط غير صحيح",
						errorLinkNosupport: "الرابط غير مدعوم",
						errorOutdateResult: "النتائج قديمة. يرجى محاولة البحث مرة أخرى",
						igUsername: "نقوم بتنزيل الملف الشخصي. الرجاء الانتظار :)",
						igUsernameLink: "نقوم بتنزيل الملف الشخصي. الرجاء الانتظار :)",
						igPost: "نقوم بتنزيل المنشور. الرجاء الانتظار :)",
						igReel: "نقوم بتنزيل الريل. الرجاء الانتظار :)",
						igStory: "نقوم بتنزيل القصة. الرجاء الانتظار :)",
						igStories: "نقوم بتنزيل القصص. الرجاء الانتظار :)",
						igHighlightStories: "نقوم بتنزيل القصص المميزة. الرجاء الانتظار :)",
						igAvatar: "نقوم بتنزيل الصورة الرمزية. الرجاء الانتظار :)",
						fbPost: "نقوم بتنزيل المنشور. الرجاء الانتظار :)",
						linkNotFound: "رابط التنزيل غير موجود",
						twPost: "نقوم بتنزيل المنشور. الرجاء الانتظار :)",
						privateAccountMessage: "لقد أدخلت رابطًا لحساب خاص. يرجى المحاولة باستخدام رابط لحساب عام.",
						noStoriesMessage: "يبدو أنه لا توجد قصص خلال آخر 24 ساعة. يرجى المحاولة مرة أخرى لاحقًا.",
						noHighlightsMessage: "لم يتم العثور على أي أبرز القصص. يرجى المحاولة مرة أخرى لاحقًا.",
						noPostsMessage: "لم يتم العثور على أي منشورات. يرجى المحاولة مرة أخرى لاحقًا.",
						noReelsMessage: "لم يتم العثور على أي Reels. يرجى المحاولة مرة أخرى لاحقًا.",
						fileNotFound: "لم يتم العثور على الملف",
						pageNotFound: "الصفحة غير موجودة",
						pageWithoutFiles: "هذه الصفحة لا تحتوي على ملفات",
						privatePage: "هذه الصفحة خاصة",
						restrictedAccess: "الوصول إلى هذه الصفحة مقيد",
						captchaRequired: "مطلوب إدخال كابتشا",
						mediaNotSupported: "نوع الوسائط هذا غير مدعوم",
						albumsNotSupported: "الألبومات غير مدعومة",
						liveUnableDownload: "لا يمكن تنزيل الفيديوهات المباشرة",
						reedMore: "اقرأ المزيد",
						seePost: "عرض هذا المنشور"
					},
					bn: {
						...
						btnBack: "ফিরে যান",
						btnDownload: "ডাউনলোড",
						btnDownloadOther: "অন্যটি ডাউনলোড করুন",
						captchaLabel: "উপরের লেখাটি প্রবেশ করুন",
						captchaIncorrectText: "ভুল লেখা",
						downloadFileReady: "আপনার ফাইল প্রস্তুত",
						downloadPage: "এটি আমাদের ওয়েবসাইটের ডাউনলোড পৃষ্ঠা। আমরা আপনার ডেটা সংরক্ষণ করি না বা আমাদের সার্ভারে কোনও সামগ্রী হোস্ট করি না।",
						downloadPageAnon: "Anonyig ব্যবহার করুন যেকোনো Instagram ভিডিও বা ছবি ডিভাইসে সংরক্ষণ করতে - বিনামূল্যে, নিরাপদ, দ্রুত এবং বেনামীভাবে।",
						errorDefault: "কিছু ভুল হয়েছে",
						errorLinkRequired: "@username বা লিঙ্ক প্রয়োজন",
						errorLinkFormat: "লিঙ্ক ফর্ম্যাট ভুল",
						errorLinkNosupport: "লিঙ্ক সমর্থিত নয়",
						errorOutdateResult: "ফলাফলটি পুরনো। অনুগ্রহ করে আবার অনুসন্ধান করুন।",
						igUsername: "প্রোফাইল ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igUsernameLink: "প্রোফাইল ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igPost: "পোস্ট ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igReel: "রিল ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igStory: "স্টোরি ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igStories: "স্টোরিগুলি ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igHighlightStories: "হাইলাইট ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						igAvatar: "অবতার ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						fbPost: "পোস্ট ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						linkNotFound: "ডাউনলোড লিঙ্ক পাওয়া যায়নি",
						twPost: "পোস্ট ডাউনলোড হচ্ছে। দয়া করে অপেক্ষা করুন :)",
						privateAccountMessage: "আপনি একটি ব্যক্তিগত অ্যাকাউন্টের লিঙ্ক প্রবেশ করেছেন। অনুগ্রহ করে একটি প্রকাশ্য অ্যাকাউন্টের লিঙ্ক ব্যবহার করে চেষ্টা করুন।",
						noStoriesMessage: "গত ২৪ ঘণ্টায় কোনো গল্প পাওয়া যায়নি। দয়া করে পরে আবার চেষ্টা করুন।",
						noHighlightsMessage: "কোনো হাইলাইটস পাওয়া যায়নি। দয়া করে পরে আবার চেষ্টা করুন।",
						noPostsMessage: "কোনো পোস্ট পাওয়া যায়নি। দয়া করে পরে আবার চেষ্টা করুন।",
						noReelsMessage: "কোনো reels পাওয়া যায়নি। দয়া করে পরে আবার চেষ্টা করুন।",
						fileNotFound: "ফাইলটি পাওয়া যায়নি",
						pageNotFound: "পৃষ্ঠাটি পাওয়া যায়নি",
						pageWithoutFiles: "এই পৃষ্ঠায় কোন ফাইল নেই",
						privatePage: "এই পৃষ্ঠাটি ব্যক্তিগত",
						restrictedAccess: "এই পৃষ্ঠায় অ্যাক্সেস সীমিত",
						captchaRequired: "ক্যাপচা প্রয়োজন",
						mediaNotSupported: "এই মিডিয়া ধরণ সমর্থিত নয়",
						albumsNotSupported: "অ্যালবাম সমর্থিত নয়",
						liveUnableDownload: "লাইভ ভিডিও ডাউনলোড করা যায় না",
						reedMore: "আরও পড়ুন",
						seePost: "এই পোস্টটি দেখুন"
					},
					cs: {
						...
						btnSubmit: "Odeslat",
						btnBack: "Zpět",
						btnDownload: "Stáhnout",
						btnDownloadOther: "Stáhnout jiný",
						captchaLabel: "zadejte text, který vidíte výše",
						captchaIncorrectText: "nesprávný text",
						downloadFileReady: "Váš soubor je připraven",
						downloadPage: "Toto je stránka ke stažení na našich webových stránkách. Neuchováváme vaše údaje ani nehostujeme žádný obsah na našem serveru.",
						downloadPageAnon: "Použijte Anonyig Instagram Downloader pro uložení jakéhokoli videa nebo fotografie z Instagramu do vašeho zařízení - zdarma, bezpečně, rychle a anonymně.",
						errorDefault: "Něco se pokazilo",
						errorLinkRequired: "@username nebo odkaz je vyžadován",
						errorLinkFormat: "Formát odkazu je nesprávný",
						errorLinkNosupport: "Odkaz není podporován",
						errorOutdateResult: "Výsledky jsou zastaralé. Zkuste prosím vyhledávání znovu",
						igUsername: "Stahujeme profil. Prosím, čekejte :)",
						igUsernameLink: "Stahujeme profil. Prosím, čekejte :)",
						igPost: "Stahujeme příspěvek. Prosím, čekejte :)",
						igReel: "Stahujeme reel. Prosím, čekejte :)",
						igStory: "Stahujeme příběh. Prosím, čekejte :)",
						igStories: "Stahujeme příběhy. Prosím, čekejte :)",
						igHighlightStories: "Stahujeme zvýrazněné příběhy. Prosím, čekejte :)",
						igAvatar: "Stahujeme avatar. Prosím, čekejte :)",
						fbPost: "Stahujeme příspěvek. Prosím, čekejte :)",
						linkNotFound: "Odkaz ke stažení nebyl nalezen",
						twPost: "Stahujeme příspěvek. Prosím, čekejte :)",
						privateAccountMessage: "Zadali jste odkaz na soukromý účet. Zkuste prosím použít odkaz na veřejný účet.",
						noStoriesMessage: "Zdá se, že za posledních 24 hodin nejsou k dispozici žádné příběhy. Zkuste to prosím znovu později.",
						noHighlightsMessage: "Nenašly se žádné zvýraznění. Zkuste to prosím znovu později.",
						noPostsMessage: "Žádné příspěvky nenalezeny. Zkuste to prosím znovu později.",
						noReelsMessage: "Nenašly se žádné reels. Zkuste to prosím znovu později.",
						fileNotFound: "Soubor nebyl nalezen",
						pageNotFound: "Stránka nebyla nalezena",
						pageWithoutFiles: "Tato stránka neobsahuje žádné soubory",
						privatePage: "Tato stránka je soukromá",
						restrictedAccess: "Přístup na tuto stránku je omezen",
						captchaRequired: "Je vyžadováno captcha",
						mediaNotSupported: "Tento typ médií není podporován",
						albumsNotSupported: "Alba nejsou podporována",
						liveUnableDownload: "Živá videa nelze stáhnout",
						reedMore: "Přečtěte si více",
						seePost: "Zobrazit tento příspěvek"
					},
					de: {
						...
						downloadPageAnon: "Verwenden Sie Anonyig, um jedes Instagram-Video oder Foto auf Ihr Gerät zu speichern - kostenlos, sicher, schnell und anonym.",
						...
						privateAccountMessage: "Sie haben den Link zu einem privaten Konto eingegeben. Bitte versuchen Sie es mit dem Link zu einem öffentlichen Konto.",
						noStoriesMessage: "Es scheint, dass es in den letzten 24 Stunden keine Stories gibt. Bitte versuchen Sie es später noch einmal.",
						noHighlightsMessage: "Keine Highlights gefunden. Bitte versuchen Sie es später noch einmal.",
						noPostsMessage: "Keine Beiträge gefunden. Bitte versuchen Sie es später noch einmal.",
						noReelsMessage: "Keine Reels gefunden. Bitte versuchen Sie es später noch einmal.",
						fileNotFound: "Datei wurde nicht gefunden",
						pageNotFound: "Seite nicht gefunden",
						pageWithoutFiles: "Diese Seite enthält keine Dateien",
						privatePage: "Diese Seite ist privat",
						restrictedAccess: "Zugriff auf diese Seite ist eingeschränkt",
						captchaRequired: "Captcha ist erforderlich",
						mediaNotSupported: "Dieser Medientyp wird nicht unterstützt",
						albumsNotSupported: "Alben werden nicht unterstützt",
						liveUnableDownload: "Live-Videos können nicht heruntergeladen werden",
						reedMore: "Mehr lesen",
					...
					el: {
						...
						btnBack: "Πίσω",
						btnDownload: "Λήψη",
						btnDownloadOther: "Λήψη άλλου",
						captchaLabel: "Εισάγετε το κείμενο που βλέπετε παραπάνω",
						captchaIncorrectText: "Λάθος κείμενο",
						downloadFileReady: "Το αρχείο σας είναι έτοιμο",
						downloadPage: "Αυτή είναι η σελίδα λήψης στον ιστότοπό μας. Δεν αποθηκεύουμε τα δεδομένα σας ή φιλοξενούμε οποιοδήποτε περιεχόμενο στον διακομιστή μας.",
						downloadPageAnon: "Χρησιμοποιήστε το Anonyig Instagram Downloader για να αποθηκεύσετε οποιοδήποτε βίντεο ή φωτογραφία από το Instagram στη συσκευή σας - δωρεάν, ασφαλές, γρήγορο και ανώνυμο.",
						errorDefault: "Κάτι πήγε στραβά",
						errorLinkRequired: "Απαιτείται @όνομαχρήστη ή σύνδεσμος",
						errorLinkFormat: "Λάθος μορφή συνδέσμου",
						errorLinkNosupport: "Ο σύνδεσμος δεν υποστηρίζεται",
						errorOutdateResult: "Τα αποτελέσματα είναι ξεπερασμένα. Δοκιμάστε ξανά την αναζήτησή σας",
						igUsername: "Κατεβάζουμε το προφίλ. Παρακαλώ περιμένετε :)",
						igUsernameLink: "Κατεβάζουμε το προφίλ. Παρακαλώ περιμένετε :)",
						igPost: "Κατεβάζουμε την ανάρτηση. Παρακαλώ περιμένετε :)",
						igReel: "Κατεβάζουμε το reel. Παρακαλώ περιμένετε :)",
						igStory: "Κατεβάζουμε την ιστορία. Παρακαλώ περιμένετε :)",
						igStories: "Κατεβάζουμε τις ιστορίες. Παρακαλώ περιμένετε :)",
						igHighlightStories: "Κατεβάζουμε το highlight. Παρακαλώ περιμένετε :)",
						igAvatar: "Κατεβάζουμε το avatar. Παρακαλώ περιμένετε :)",
						fbPost: "Κατεβάζουμε την ανάρτηση. Παρακαλώ περιμένετε :)",
						linkNotFound: "Ο σύνδεσμος λήψης δεν βρέθηκε",
						twPost: "Κατεβάζουμε την ανάρτηση. Παρακαλώ περιμένετε :)",
						privateAccountMessage: "Έχετε εισαγάγει τον σύνδεσμο σε έναν ιδιωτικό λογαριασμό. Δοκιμάστε να χρησιμοποιήσετε τον σύνδεσμο σε έναν δημόσιο λογαριασμό.",
						noStoriesMessage: "Φαίνεται ότι δεν υπάρχουν ιστορίες για τις τελευταίες 24 ώρες. Παρακαλώ δοκιμάστε ξανά αργότερα.",
						noHighlightsMessage: "Δεν βρέθηκαν στιγμιότυπα. Παρακαλώ δοκιμάστε ξανά αργότερα.",
						noPostsMessage: "Δεν βρέθηκαν δημοσιεύσεις. Παρακαλώ δοκιμάστε ξανά αργότερα.",
						noReelsMessage: "Δεν βρέθηκαν reels. Παρακαλώ δοκιμάστε ξανά αργότερα.",
						fileNotFound: "Το αρχείο δεν βρέθηκε",
						pageNotFound: "Η σελίδα δεν βρέθηκε",
						pageWithoutFiles: "Αυτή η σελίδα δεν περιέχει αρχεία",
						privatePage: "Αυτή η σελίδα είναι ιδιωτική",
						restrictedAccess: "Η πρόσβαση σε αυτήν τη σελίδα είναι περιορισμένη",
						captchaRequired: "Απαιτείται captcha",
						mediaNotSupported: "Αυτός ο τύπος μέσου δεν υποστηρίζεται",
						albumsNotSupported: "Τα άλμπουμ δεν υποστηρίζονται",
						liveUnableDownload: "Τα ζωντανά βίντεο δεν μπορούν να ληφθούν",
						reedMore: "Διαβάστε περισσότερα",
						seePost: "Δείτε αυτήν την ανάρτηση"
					},
					en: {
					...
					es: {
						...
						downloadFileReady: "Tu archivo está listo",
						downloadPage: "Esta es la página de descarga de nuestro sitio web. No almacenamos tus datos ni alojamos contenido en nuestro servidor.",
						downloadPageAnon: "Usa Anonyig para descargar cualquier video o foto de Instagram en tu dispositivo - gratis, seguro, rápido y anónimo.",
						...
						igPost: "Estamos descargando la publicación. Por favor, espera :)",
						...
						fbPost: "Estamos descargando la publicación. Por favor, espera :)",
						linkNotFound: "Enlace de descarga no encontrado",
						twPost: "Estamos descargando la publicación. Por favor, espera :)",
						privateAccountMessage: "Has introducido el enlace a una cuenta privada. Por favor, intenta usar el enlace a una cuenta pública.",
						noStoriesMessage: "Parece que no hay historias en las últimas 24 horas. Inténtalo de nuevo más tarde.",
						noHighlightsMessage: "No se encontraron historias destacadas. Inténtalo de nuevo más tarde.",
						noPostsMessage: "No se encontraron publicaciones. Inténtalo de nuevo más tarde.",
						noReelsMessage: "No se encontraron reels. Inténtalo de nuevo más tarde.",
						fileNotFound: "Archivo no encontrado",
						pageNotFound: "Página no encontrada",
						pageWithoutFiles: "Esta página no contiene archivos",
						privatePage: "Esta página es privada",
						restrictedAccess: "Acceso restringido a esta página",
						captchaRequired: "Se requiere captcha",
						mediaNotSupported: "Este tipo de medio no es compatible",
						albumsNotSupported: "Álbumes no compatibles",
						liveUnableDownload: "No se pueden descargar videos en vivo",
						reedMore: "Leer más",
						seePost: "Ver esta publicación"
					},
					fa: {
						...
						btnBack: "بازگشت",
						btnDownload: "دانلود",
						btnDownloadOther: "دانلود دیگری",
						captchaLabel: "متن بالا را وارد کنید",
						captchaIncorrectText: "متن نادرست",
						downloadFileReady: "فایل شما آماده است",
						downloadPage: "این صفحه دانلود در وب‌سایت ما است. ما اطلاعات شما را ذخیره نمی‌کنیم یا هیچ محتوایی را در سرور خود میزبانی نمی‌کنیم.",
						downloadPageAnon: "از Anonyig برای دانلود هر ویدیو یا عکسی از اینستاگرام به دستگاه خود استفاده کنید - رایگان، امن، سریع و ناشناس.",
						errorDefault: "مشکلی پیش آمده است",
						errorLinkRequired: "@نام‌کاربری یا لینک الزامی است",
						errorLinkFormat: "فرمت لینک نادرست است",
						errorLinkNosupport: "لینک پشتیبانی نمی‌شود",
						errorOutdateResult: "نتایج منسوخ شده است. دوباره جستجو رو امتحان کن",
						igUsername: "در حال دانلود پروفایل هستیم. لطفاً صبر کنید :)",
						igUsernameLink: "در حال دانلود پروفایل هستیم. لطفاً صبر کنید :)",
						igPost: "در حال دانلود پست هستیم. لطفاً صبر کنید :)",
						igReel: "در حال دانلود ریل هستیم. لطفاً صبر کنید :)",
						igStory: "در حال دانلود استوری هستیم. لطفاً صبر کنید :)",
						igStories: "در حال دانلود استوری‌ها هستیم. لطفاً صبر کنید :)",
						igHighlightStories: "در حال دانلود هایلایت هستیم. لطفاً صبر کنید :)",
						igAvatar: "در حال دانلود آواتار هستیم. لطفاً صبر کنید :)",
						fbPost: "در حال دانلود پست هستیم. لطفاً صبر کنید :)",
						linkNotFound: "پیوند دانلود یافت نشد",
						twPost: "در حال دانلود پست هستیم. لطفاً صبر کنید :)",
						privateAccountMessage: "شما لینک به یک حساب خصوصی را وارد کرده‌اید. لطفاً از لینک یک حساب عمومی استفاده کنید.",
						noStoriesMessage: "به نظر می‌رسد در ۲۴ ساعت گذشته هیچ داستانی وجود ندارد. لطفاً بعداً دوباره تلاش کنید.",
						noHighlightsMessage: "هیچ نکته برجسته‌ای یافت نشد. لطفاً بعداً دوباره تلاش کنید.",
						noPostsMessage: "هیچ پستی یافت نشد. لطفاً بعداً دوباره تلاش کنید.",
						noReelsMessage: "هیچ ریلزی یافت نشد. لطفاً بعداً دوباره تلاش کنید.",
						fileNotFound: "فایل پیدا نشد",
						pageNotFound: "صفحه پیدا نشد",
						pageWithoutFiles: "این صفحه شامل هیچ فایلی نیست",
						privatePage: "این صفحه خصوصی است",
						restrictedAccess: "دسترسی به این صفحه محدود شده است",
						captchaRequired: "کپچا مورد نیاز است",
						mediaNotSupported: "این نوع رسانه پشتیبانی نمی‌شود",
						albumsNotSupported: "آلبوم‌ها پشتیبانی نمی‌شوند",
						liveUnableDownload: "دانلود ویدیوهای زنده امکان‌پذیر نیست",
						reedMore: "ادامه مطلب",
						seePost: "مشاهده این پست"
					},
					fr: {
						...
						btnDownloadOther: "Télécharger un autre",
						captchaLabel: "entrez le texte que vous voyez ci-dessus",
						captchaIncorrectText: "texte incorrect",
						downloadFileReady: "Votre fichier est prêt",
						downloadPage: "Ceci est la page de téléchargement sur notre site web. Nous ne stockons pas vos données ni n'hébergeons de contenu sur notre serveur.",
						downloadPageAnon: "Utilisez Anonyig pour télécharger n'importe quelle vidéo ou photo d'Instagram sur votre appareil - gratuit, sécurisé, rapide et anonyme.",
						errorDefault: "Quelque chose s'est mal passé",
						errorLinkRequired: "@nomdutilisateur ou lien est requis",
						errorLinkFormat: "Le format du lien est incorrect",
						errorLinkNosupport: "Le lien n'est pas supporté",
						errorOutdateResult: "Résultats obsolètes. Relancez la recherche",
						igUsername: "Nous téléchargeons le profil. Veuillez patienter :)",
						igUsernameLink: "Nous téléchargeons le profil. Veuillez patienter :)",
						igPost: "Nous téléchargeons la publication. Veuillez patienter :)",
						igReel: "Nous téléchargeons le reel. Veuillez patienter :)",
						igStory: "Nous téléchargeons l'histoire. Veuillez patienter :)",
						igStories: "Nous téléchargeons les histoires. Veuillez patienter :)",
						igHighlightStories: "Nous téléchargeons les moments forts. Veuillez patienter :)",
						igAvatar: "Nous téléchargeons l'avatar. Veuillez patienter :)",
						fbPost: "Nous téléchargeons la publication. Veuillez patienter :)",
						linkNotFound: "Lien de téléchargement introuvable",
						twPost: "Nous téléchargeons la publication. Veuillez patienter :)",
						privateAccountMessage: "Vous avez entré le lien d'un compte privé. Veuillez essayer d'utiliser le lien d'un compte public.",
						noStoriesMessage: "Il semble qu'il n'y ait pas d'histoires des dernières 24 heures. Veuillez réessayer plus tard.",
						noHighlightsMessage: "Aucun contenu à la une trouvé. Veuillez réessayer plus tard.",
						noPostsMessage: "Aucun post trouvé. Veuillez réessayer plus tard.",
						noReelsMessage: "Aucun reel trouvé. Veuillez réessayer plus tard.",
						fileNotFound: "Fichier non trouvé",
						pageNotFound: "Page non trouvée",
						pageWithoutFiles: "Cette page ne contient aucun fichier",
						privatePage: "Cette page est privée",
						restrictedAccess: "Accès restreint à cette page",
						captchaRequired: "Captcha requis",
						mediaNotSupported: "Ce type de média n'est pas pris en charge",
						albumsNotSupported: "Les albums ne sont pas pris en charge",
						liveUnableDownload: "Impossible de télécharger les vidéos en direct",
					...
					hu: {
						...
						btnDownloadOther: "Másik letöltése",
						captchaLabel: "írja be a fent látható szöveget",
						captchaIncorrectText: "helytelen szöveg",
						downloadFileReady: "A fájl készen áll",
						downloadPage: "Ez a letöltési oldalunk. Nem tároljuk az adatait és nem tárolunk tartalmat a szerverünkön.",
						downloadPageAnon: "Használja az Anonyig Instagram letöltőt, hogy bármilyen videót vagy fotót mentsen az Instagramról - ingyenesen, biztonságosan, gyorsan és névtelenül.",
						errorDefault: "Valami hiba történt",
						errorLinkRequired: "@felhasználónév vagy hivatkozás szükséges",
						errorLinkFormat: "A hivatkozás formátuma helytelen",
						errorLinkNosupport: "A hivatkozás nem támogatott",
						errorOutdateResult: "Az eredmények elavultak. Próbálja újra a keresést",
						igUsername: "A profil letöltése folyamatban van. Kérem várjon :)",
						igUsernameLink: "A profil letöltése folyamatban van. Kérem várjon :)",
						igPost: "A bejegyzés letöltése folyamatban van. Kérem várjon :)",
						igReel: "A reel letöltése folyamatban van. Kérem várjon :)",
						igStory: "A történet letöltése folyamatban van. Kérem várjon :)",
						igStories: "A történetek letöltése folyamatban van. Kérem várjon :)",
						igHighlightStories: "A kiemelt történet letöltése folyamatban van. Kérem várjon :)",
						igAvatar: "Az avatar letöltése folyamatban van. Kérem várjon :)",
						fbPost: "A bejegyzés letöltése folyamatban van. Kérem várjon :)",
						linkNotFound: "A letöltési link nem található",
						twPost: "A bejegyzés letöltése folyamatban van. Kérem várjon :)",
						privateAccountMessage: "Egy privát fiók linkjét adta meg. Kérjük, próbálja meg egy nyilvános fiók linkjét használni.",
						noStoriesMessage: "Úgy tűnik, az elmúlt 24 órában nem voltak történetek. Kérjük, próbálja újra később.",
						noHighlightsMessage: "Nem találtunk kiemeléseket. Kérjük, próbálja újra később.",
						noPostsMessage: "Nem találtunk bejegyzéseket. Kérjük, próbálja újra később.",
						noReelsMessage: "Nem találtunk reels. Kérjük, próbálja újra később.",
						fileNotFound: "A fájl nem található",
						pageNotFound: "Az oldal nem található",
						pageWithoutFiles: "Ez az oldal nem tartalmaz fájlokat",
						privatePage: "Ez egy privát oldal",
						restrictedAccess: "Korlátozott hozzáférés az oldalhoz",
						captchaRequired: "Captcha szükséges",
						mediaNotSupported: "Ez a médiafájl-típus nem támogatott",
						albumsNotSupported: "Az albumok nem támogatottak",
						liveUnableDownload: "Az élő videók nem tölthetők le",
						reedMore: "Tovább olvasom",
						seePost: "Nézd meg ezt a bejegyzést"
					},
					hi: {
						...
						btnBack: "वापस जाएं",
						btnDownload: "डाउनलोड",
						btnDownloadOther: "दूसरा डाउनलोड करें",
						captchaLabel: "ऊपर दिखाए गए टेक्स्ट को दर्ज करें",
						captchaIncorrectText: "गलत टेक्स्ट",
						downloadFileReady: "आपकी फ़ाइल तैयार है",
						downloadPage: "यह हमारी वेबसाइट पर डाउनलोड पेज है। हम आपकी जानकारी संग्रहीत नहीं करते हैं और न ही हमारे सर्वर पर कोई सामग्री होस्ट करते हैं।",
						downloadPageAnon: "Anonyig Instagram Downloader का उपयोग करके किसी भी Instagram वीडियो या फोटो को अपने डिवाइस पर सहेजें - मुफ़्त, सुरक्षित, तेज़ और गुमनाम।",
						errorDefault: "कुछ गलत हो गया",
						errorLinkRequired: "@उपयोगकर्तानाम या लिंक आवश्यक है",
						errorLinkFormat: "लिंक का प्रारूप गलत है",
						errorLinkNosupport: "लिंक समर्थित नहीं है",
						errorOutdateResult: "परिणाम पुराने हैं। अपनी खोज को फिर से आज़माएं",
						igUsername: "हम प्रोफ़ाइल डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igUsernameLink: "हम प्रोफ़ाइल डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igPost: "हम पोस्ट डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igReel: "हम रील डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igStory: "हम स्टोरी डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igStories: "हम स्टोरीज़ डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igHighlightStories: "हम हाइलाइट डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						igAvatar: "हम अवतार डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						fbPost: "हम पोस्ट डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						linkNotFound: "डाउनলোড লিংক नहीं मिला",
						twPost: "हम पोस्ट डाउनलोड कर रहे हैं। कृपया प्रतीक्षा करें :)",
						privateAccountMessage: "आपने एक निजी खाता लिंक दर्ज किया है। कृपया एक सार्वजनिक खाता लिंक का उपयोग करने का प्रयास करें।",
						noStoriesMessage: "ऐसा लगता है कि पिछले 24 घंटों में कोई स्टोरी नहीं है। कृपया बाद में पुनः प्रयास करें।",
						noHighlightsMessage: "कोई हाइलाइट्स नहीं मिली। कृपया बाद में पुनः प्रयास करें।",
						noPostsMessage: "कोई पोस्ट नहीं मिली। कृपया बाद में पुनः प्रयास करें।",
						noReelsMessage: "कोई रील्स नहीं मिली। कृपया बाद में पुनः प्रयास करें।",
						fileNotFound: "फ़ाइल नहीं मिली",
						pageNotFound: "पृष्ठ नहीं मिला",
						pageWithoutFiles: "इस पृष्ठ में कोई फ़ाइल नहीं है",
						privatePage: "यह पृष्ठ निजी है",
						restrictedAccess: "इस पृष्ठ तक पहुंच प्रतिबंधित है",
						captchaRequired: "कैप्चा आवश्यक है",
						mediaNotSupported: "यह मीडिया प्रकार समर्थित नहीं है",
						albumsNotSupported: "एल्बम समर्थित नहीं हैं",
						liveUnableDownload: "लाइव वीडियो डाउनलोड नहीं किए जा सकते",
						reedMore: "और पढ़ें",
						seePost: "यह पोस्ट देखें"
					},
					id: {
					...
					it: {
						...
						downloadFileReady: "Il tuo file è pronto",
						downloadPage: "Questa è la pagina di download del nostro sito web. Non memorizziamo i tuoi dati né ospitiamo alcun contenuto sul nostro server.",
						...
						errorLinkRequired: "È richiesto @nomeutente o un link",
						errorLinkFormat: "Il formato del link è errato",
						errorLinkNosupport: "Il link non è supportato",
						...
						noStoriesMessage: "Sembra che non ci siano storie nelle ultime 24 ore. Per favore riprova più tardi.",
						noHighlightsMessage: "Nessun contenuto in evidenza trovato. Per favore riprova più tardi.",
						noPostsMessage: "Nessun post trovato. Per favore riprova più tardi.",
						noReelsMessage: "Nessun reel trovato. Per favore riprova più tardi.",
						fileNotFound: "File non trovato",
						pageNotFound: "Pagina non trovata",
						pageWithoutFiles: "Questa pagina non contiene file",
						privatePage: "Questa pagina è privata",
						restrictedAccess: "Accesso a questa pagina limitato",
						captchaRequired: "Captcha obbligatorio",
						mediaNotSupported: "Questo tipo di media non è supportato",
						albumsNotSupported: "Album non supportati",
						liveUnableDownload: "Impossibile scaricare video live",
						reedMore: "Leggi di più",
					...
					ja: {
						...
						btnBack: "戻る",
						btnDownload: "ダウンロード",
						btnDownloadOther: "他のファイルをダウンロード",
						captchaLabel: "上に表示されているテキストを入力してください",
						captchaIncorrectText: "間違ったテキスト",
						downloadFileReady: "ファイルの準備ができました",
						downloadPage: "これは当社のウェブサイトのダウンロードページです。私たちはあなたのデータを保存せず、サーバー上でコンテンツをホストしません。",
						downloadPageAnon: "Anonyig Instagram ダウンローダーを使用して、Instagram のビデオや写真をデバイスに保存してください - 無料、安全、迅速、匿名。",
						errorDefault: "問題が発生しました",
						errorLinkRequired: "@ユーザー名またはリンクが必要です",
						errorLinkFormat: "リンク形式が正しくありません",
						errorLinkNosupport: "リンクがサポートされていません",
						errorOutdateResult: "結果が古いです。再検索してください",
						igUsername: "プロフィールをダウンロードしています。お待ちください :)",
						igUsernameLink: "プロフィールをダウンロードしています。お待ちください :)",
						igPost: "投稿をダウンロードしています。お待ちください :)",
						igReel: "リールをダウンロードしています。お待ちください :)",
						igStory: "ストーリーをダウンロードしています。お待ちください :)",
						igStories: "ストーリーズをダウンロードしています。お待ちください :)",
						igHighlightStories: "ハイライトをダウンロードしています。お待ちください :)",
						igAvatar: "アバターをダウンロードしています。お待ちください :)",
						fbPost: "投稿をダウンロードしています。お待ちください :)",
						linkNotFound: "ダウンロードリンクが見つかりません",
						twPost: "投稿をダウンロードしています。お待ちください :)",
						privateAccountMessage: "プライベートアカウントのリンクを入力しました。パブリックアカウントのリンクを使用してください。",
						noStoriesMessage: "過去24時間のストーリーがありません。後でもう一度お試しください。",
						noHighlightsMessage: "ハイライトが見つかりませんでした。後でもう一度お試しください。",
						noPostsMessage: "投稿が見つかりませんでした。後でもう一度お試しください。",
						noReelsMessage: "リールが見つかりませんでした。後でもう一度お試しください。",
						fileNotFound: "ファイルが見つかりません",
						pageNotFound: "ページが見つかりません",
						pageWithoutFiles: "このページにファイルはありません",
						privatePage: "これは非公開ページです",
						restrictedAccess: "このページへのアクセスは制限されています",
						captchaRequired: "キャプチャが必要です",
						mediaNotSupported: "このメディアタイプはサポートされていません",
						albumsNotSupported: "アルバムはサポートされていません",
						liveUnableDownload: "ライブ動画はダウンロードできません",
						reedMore: "続きを読む",
						seePost: "この投稿を見る"
					},
					ko: {
						...
						btnBack: "돌아가기",
						btnDownload: "다운로드",
						btnDownloadOther: "다른 파일 다운로드",
						captchaLabel: "위에 보이는 텍스트를 입력하세요",
						captchaIncorrectText: "잘못된 텍스트",
						downloadFileReady: "파일이 준비되었습니다",
						downloadPage: "이 페이지는 당사 웹사이트의 다운로드 페이지입니다. 당사는 귀하의 데이터를 저장하지 않으며, 서버에 어떠한 콘텐츠도 호스팅하지 않습니다.",
						downloadPageAnon: "Anonyig Instagram 다운로더를 사용하여 Instagram 비디오 또는 사진을 기기에 저장하세요 - 무료, 안전, 빠르고 익명입니다.",
						errorDefault: "문제가 발생했습니다",
						errorLinkRequired: "@사용자 이름 또는 링크가 필요합니다",
						errorLinkFormat: "링크 형식이 잘못되었습니다",
						errorLinkNosupport: "링크가 지원되지 않습니다",
						errorOutdateResult: "오래된 결과입니다. 다시 검색하세요.",
						igUsername: "프로필을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igUsernameLink: "프로필을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igPost: "게시물을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igReel: "릴을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igStory: "스토리를 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igStories: "스토리들을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igHighlightStories: "하이라이트를 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						igAvatar: "아바타를 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						fbPost: "게시물을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						linkNotFound: "다운로드 링크를 찾을 수 없습니다",
						twPost: "게시물을 다운로드 중입니다. 잠시만 기다려 주세요 :)",
						privateAccountMessage: "비공개 계정의 링크를 입력했습니다. 공개 계정의 링크를 사용해 주세요.",
						noStoriesMessage: "지난 24시간 동안 스토리가 없는 것 같습니다. 나중에 다시 시도해 주세요.",
						noHighlightsMessage: "하이라이트를 찾을 수 없습니다. 나중에 다시 시도해 주세요.",
						noPostsMessage: "게시물을 찾을 수 없습니다. 나중에 다시 시도해 주세요.",
						noReelsMessage: "리일을 찾을 수 없습니다. 나중에 다시 시도해 주세요.",
						fileNotFound: "파일을 찾을 수 없음",
						pageNotFound: "페이지를 찾을 수 없음",
						pageWithoutFiles: "이 페이지에는 파일이 없습니다",
						privatePage: "비공개 페이지입니다",
						restrictedAccess: "이 페이지에 대한 접근이 제한됨",
						captchaRequired: "캡챠가 필요합니다",
						mediaNotSupported: "이 미디어 유형은 지원되지 않습니다",
						albumsNotSupported: "앨범은 지원되지 않습니다",
						liveUnableDownload: "라이브 동영상은 다운로드할 수 없습니다",
						reedMore: "더 읽기",
						seePost: "이 게시물 보기"
					},
					ms: {
					...
					nl: {
						...
						privateAccountMessage: "Je hebt de link naar een privéaccount ingevoerd. Probeer de link naar een openbaar account te gebruiken.",
						...
						privatePage: "Deze pagina is privé",
					...
					pl: {
						...
						captchaLabel: "Wprowadź tekst, który widzisz powyżej",
						captchaIncorrectText: "Niepoprawny tekst",
						downloadFileReady: "Twój plik jest gotowy",
						downloadPage: "To jest strona pobierania na naszej stronie internetowej. Nie przechowujemy Twoich danych ani nie hostujemy żadnych treści na naszym serwerze.",
						downloadPageAnon: "Użyj Anonyig, aby pobrać dowolny film lub zdjęcie z Instagrama na swoje urządzenie - za darmo, bezpiecznie, szybko i anonimowo.",
						errorDefault: "Coś poszło nie tak",
						errorLinkRequired: "@nazwa użytkownika lub link jest wymagany",
						errorLinkFormat: "Niepoprawny format linku",
						errorLinkNosupport: "Link nie jest obsługiwany",
						errorOutdateResult: "Wyniki są nieaktualne. Proszę wyszukać ponownie",
						igUsername: "Pobieramy profil. Proszę czekać :)",
						igUsernameLink: "Pobieramy profil. Proszę czekać :)",
						igPost: "Pobieramy post. Proszę czekać :)",
						igReel: "Pobieramy reel. Proszę czekać :)",
						igStory: "Pobieramy historię. Proszę czekać :)",
						igStories: "Pobieramy historie. Proszę czekać :)",
						igHighlightStories: "Pobieramy wyróżnione historie. Proszę czekać :)",
						igAvatar: "Pobieramy avatar. Proszę czekać :)",
						fbPost: "Pobieramy post. Proszę czekać :)",
						linkNotFound: "Nie znaleziono linku do pobrania",
						twPost: "Pobieramy post. Proszę czekać :)",
						privateAccountMessage: "Wprowadziłeś link do prywatnego konta. Spróbuj użyć linku do konta publicznego.",
						noStoriesMessage: "Wygląda na to, że nie ma żadnych historii z ostatnich 24 godzin. Spróbuj ponownie później.",
						noHighlightsMessage: "Nie znaleziono żadnych wyróżnionych. Spróbuj ponownie później.",
						noPostsMessage: "Nie znaleziono postów. Spróbuj ponownie później.",
						noReelsMessage: "Nie znaleziono reels. Spróbuj ponownie później.",
						fileNotFound: "Nie znaleziono pliku",
						pageNotFound: "Nie znaleziono strony",
						pageWithoutFiles: "Ta strona nie zawiera plików",
						privatePage: "Ta strona jest prywatna",
						restrictedAccess: "Ograniczony dostęp do tej strony",
						captchaRequired: "Wymagany captcha",
						mediaNotSupported: "Ten typ multimediów nie jest obsługiwany",
						albumsNotSupported: "Albumy nie są obsługiwane",
						liveUnableDownload: "Nie można pobrać transmisji na żywo",
						reedMore: "Czytaj więcej",
					...
					pt: {
						...
						captchaLabel: "Insira o texto que você vê acima",
						captchaIncorrectText: "Texto incorreto",
						downloadFileReady: "Seu arquivo está pronto",
						downloadPage: "Esta é a página de download em nosso site. Não armazenamos seus dados nem hospedamos nenhum conteúdo em nosso servidor.",
						downloadPageAnon: "Use o Anonyig para baixar qualquer vídeo ou foto do Instagram para o seu dispositivo - gratuito, seguro, rápido e anônimo.",
						errorDefault: "Algo deu errado",
						errorLinkRequired: "@nome de usuário ou link é necessário",
						errorLinkFormat: "Formato de link incorreto",
						errorLinkNosupport: "Link não suportado",
						errorOutdateResult: "Os resultados estão ultrapassados. Tente sua pesquisa novamente",
						...
						igStory: "Estamos baixando a história. Por favor, aguarde :)",
						igStories: "Estamos baixando as histórias. Por favor, aguarde :)",
						...
						linkNotFound: "Link para download não encontrado",
						twPost: "Estamos baixando a postagem. Por favor, aguarde :)",
						privateAccountMessage: "Você inseriu o link para uma conta privada. Por favor, tente usar o link para uma conta pública.",
						noStoriesMessage: "Parece que não há histórias nas últimas 24 horas. Por favor, tente novamente mais tarde.",
						...
						pageWithoutFiles: "Esta página não contém arquivos",
						privatePage: "Esta página é privada",
						restrictedAccess: "Acesso restrito a esta página",
						captchaRequired: "Captcha obrigatório",
						mediaNotSupported: "Este tipo de mídia não é suportado",
						albumsNotSupported: "Álbuns não são suportados",
						liveUnableDownload: "Vídeos ao vivo não podem ser baixados",
						reedMore: "Leia mais",
					...
					ro: {
						...
						btnSubmit: "Trimite",
						btnBack: "Înapoi",
						btnDownload: "Descarcă",
						btnDownloadOther: "Descarcă altul",
						captchaLabel: "Introdu textul de mai sus",
						captchaIncorrectText: "Text incorect",
						downloadFileReady: "Fișierul tău este pregătit",
						downloadPage: "Aceasta este pagina de descărcare de pe site-ul nostru. Nu stocăm datele tale și nu găzduim conținut pe serverul nostru.",
						downloadPageAnon: "Folosește Anonyig Instagram Downloader pentru a salva orice video sau fotografie de pe Instagram pe dispozitivul tău - gratuit, sigur, rapid și anonim.",
						...
						errorOutdateResult: "Rezultatele sunt depășite. Încercați din nou căutarea",
						igUsername: "Descărcăm profilul. Te rog așteaptă :)",
						igUsernameLink: "Descărcăm profilul. Te rog așteaptă :)",
						igPost: "Descărcăm postarea. Te rog așteaptă :)",
						igReel: "Descărcăm reel-ul. Te rog așteaptă :)",
						igStory: "Descărcăm povestea. Te rog așteaptă :)",
						igStories: "Descărcăm poveștile. Te rog așteaptă :)",
						igHighlightStories: "Descărcăm povestea de la Highlight. Te rog așteaptă :)",
						igAvatar: "Descărcăm avatarul. Te rog așteaptă :)",
						fbPost: "Descărcăm postarea. Te rog așteaptă :)",
						linkNotFound: "Linkul de descărcare nu a fost găsit",
						twPost: "Descărcăm postarea. Te rog așteaptă :)",
						privateAccountMessage: "Ați introdus un link către un cont privat. Vă rugăm să încercați să folosiți un link către un cont public.",
						noStoriesMessage: "Se pare că nu există povești în ultimele 24 de ore. Vă rugăm să încercați din nou mai târziu.",
						noHighlightsMessage: "Nu s-au găsit momente importante. Vă rugăm să încercați din nou mai târziu.",
						noPostsMessage: "Nu s-au găsit postări. Vă rugăm să încercați din nou mai târziu.",
						noReelsMessage: "Nu s-au găsit reels. Vă rugăm să încercați din nou mai târziu.",
						fileNotFound: "Fișierul nu a fost găsit",
						pageNotFound: "Pagina nu a fost găsită",
						pageWithoutFiles: "Această pagină nu conține fișiere",
						privatePage: "Această pagină este privată",
						restrictedAccess: "Acces restricționat la această pagină",
						...
						liveUnableDownload: "Videoclipurile live nu pot fi descărcate",
						reedMore: "Citește mai mult",
						seePost: "Vezi această postare"
					},
					ru: {
						...
						btnBack: "Назад",
						btnDownload: "Скачать",
						btnDownloadOther: "Скачать другой",
						captchaLabel: "Введите текст, который видите выше",
						captchaIncorrectText: "Неверный текст",
						downloadFileReady: "Ваш файл готов",
						downloadPage: "Это страница загрузки на нашем сайте. Мы не храним ваши данные и не размещаем контент на нашем сервере.",
						downloadPageAnon: "Используйте Anonyig для скачивания любых видео или фотографий с Instagram на ваше устройство - бесплатно, безопасно, быстро и анонимно.",
						errorDefault: "Что-то пошло не так",
						errorLinkRequired: "@имя пользователя или ссылка обязательны",
						errorLinkFormat: "Неправильный формат ссылки",
						errorLinkNosupport: "Ссылка не поддерживается",
						errorOutdateResult: "Выдача устарела. Пожалуйста, повторите поиск",
						igUsername: "Загружаем профиль. Пожалуйста, подождите :)",
						igUsernameLink: "Загружаем профиль. Пожалуйста, подождите :)",
						igPost: "Загружаем пост. Пожалуйста, подождите :)",
						igReel: "Загружаем reel. Пожалуйста, подождите :)",
						igStory: "Загружаем историю. Пожалуйста, подождите :)",
						igStories: "Загружаем истории. Пожалуйста, подождите :)",
						igHighlightStories: "Загружаем Highlight. Пожалуйста, подождите :)",
						igAvatar: "Загружаем аватар. Пожалуйста, подождите :)",
						fbPost: "Загружаем пост. Пожалуйста, подождите :)",
						linkNotFound: "Ссылка для скачивания не найдена",
						twPost: "Загружаем пост. Пожалуйста, подождите :)",
						privateAccountMessage: "Вы ввели ссылку на частный аккаунт. Попробуйте использовать ссылку на публичный аккаунт.",
						noStoriesMessage: "Похоже, за последние 24 часа нет историй. Попробуйте позже.",
						noHighlightsMessage: "Хайлайтов не найдено. Попробуйте позже.",
						noPostsMessage: "Постов не найдено. Попробуйте позже.",
						noReelsMessage: "Reels не найдено. Попробуйте позже.",
						fileNotFound: "Файл не найден",
						pageNotFound: "Страница не найдена",
						pageWithoutFiles: "На этой странице нет файлов",
						privatePage: "Это приватная страница",
						restrictedAccess: "Доступ к этой странице ограничен",
						captchaRequired: "Требуется капча",
						mediaNotSupported: "Этот тип медиа не поддерживается",
						albumsNotSupported: "Альбомы не поддерживаются",
						liveUnableDownload: "Прямые трансляции нельзя скачать",
					...
					sk: {
						...
						readMore: "Čítať viac",
						btnSubmit: "Odoslať",
						btnBack: "Vrátiť sa späť",
						btnDownload: "Stiahnuť",
						btnDownloadOther: "Stiahnuť iný",
						captchaLabel: "zadajte text, ktorý vidíte vyššie",
						captchaIncorrectText: "nesprávny text",
						downloadFileReady: "Váš súbor je pripravený",
						downloadPage: "Toto je stránka na stiahnutie na našej webovej stránke. Neuchovávame vaše údaje ani nehostujeme žiadny obsah na našom serveri.",
						downloadPageAnon: "Použite Anonyig Instagram Downloader na uloženie akéhokoľvek videa alebo fotografie z Instagramu do vášho zariadenia - zadarmo, bezpečne, rýchlo a anonymne.",
						errorDefault: "Niečo sa pokazilo",
						errorLinkRequired: "@username alebo odkaz je povinný",
						errorLinkFormat: "Formát odkazu je nesprávny",
						errorLinkNosupport: "Odkaz nie je podporovaný",
						errorOutdateResult: "Výsledky sú zastarané. Skúste vyhľadávanie znova",
						igUsername: "Sťahujeme profil. Prosím čakajte :)",
						igUsernameLink: "Sťahujeme profil. Prosím čakajte :)",
						igPost: "Sťahujeme príspevok. Prosím čakajte :)",
						igReel: "Sťahujeme reel. Prosím čakajte :)",
						igStory: "Sťahujeme príbeh. Prosím čakajte :)",
						igStories: "Sťahujeme príbehy. Prosím čakajte :)",
						igHighlightStories: "Sťahujeme zvýraznené príbehy. Prosím čakajte :)",
						igAvatar: "Sťahujeme avatar. Prosím čakajte :)",
						fbPost: "Sťahujeme príspevok. Prosím čakajte :)",
						linkNotFound: "Odkaz na stiahnutie sa nenašiel",
						twPost: "Sťahujeme príspevok. Prosím čakajte :)",
						privateAccountMessage: "Zadali ste odkaz na súkromný účet. Skúste použiť odkaz na verejný účet.",
						noStoriesMessage: "Zdá sa, že za posledných 24 hodín nie sú k dispozícii žiadne príbehy. Skúste to prosím neskôr.",
						noHighlightsMessage: "Neboli nájdené žiadne zvýraznenia. Skúste to prosím neskôr.",
						noPostsMessage: "Neboli nájdené žiadne príspevky. Skúste to prosím neskôr.",
						noReelsMessage: "Neboli nájdené žiadne reels. Skúste to prosím neskôr.",
						fileNotFound: "Súbor sa nenašiel",
						pageNotFound: "Stránka sa nenašla",
						pageWithoutFiles: "Táto stránka neobsahuje žiadne súbory",
						privatePage: "Táto stránka je súkromná",
						restrictedAccess: "Prístup na túto stránku je obmedzený",
						captchaRequired: "Vyžaduje sa captcha",
						mediaNotSupported: "Tento typ médií nie je podporovaný",
						albumsNotSupported: "Albumy nie sú podporované",
						liveUnableDownload: "Živé videá nie je možné stiahnuť",
						reedMore: "Čítať ďalej",
						seePost: "Zobraziť tento príspevok"
					},
					sr: {
						...
						btnBack: "Назад",
						btnDownload: "Преузми",
						btnDownloadOther: "Преузми друго",
						captchaLabel: "Унесите текст који видите изнад",
						captchaIncorrectText: "Нетачан текст",
						downloadFileReady: "Ваш фајл је спреман",
						downloadPage: "Ово је страница за преузимање на нашем сајту. Ми не чувамо ваше податке и не хостујемо садржај на нашем серверу.",
						downloadPageAnon: "Користите Anonyig Instagram Downloader да сачувате било који видео или слику са Инстаграма на свој уређај - бесплатно, безбедно, брзо и анонимно.",
						errorDefault: "Дошло је до грешке",
						errorLinkRequired: "@корисничко име или линк је потребан",
						errorLinkFormat: "Формат линка је нетачан",
						errorLinkNosupport: "Линк није подржан",
						errorOutdateResult: "Резултати претраге су застарели. Покушајте поново да претражите",
						igUsername: "Преузимамо профил. Молимо вас сачекајте :)",
						igUsernameLink: "Преузимамо профил. Молимо вас сачекајте :)",
						igPost: "Преузимамо објаву. Молимо вас сачекајте :)",
						igReel: "Преузимамо reel. Молимо вас сачекајте :)",
						igStory: "Преузимамо причу. Молимо вас сачекајте :)",
						igStories: "Преузимамо приче. Молимо вас сачекајте :)",
						igHighlightStories: "Преузимамо најважније приче. Молимо вас сачекајте :)",
						igAvatar: "Преузимамо аватар. Молимо вас сачекајте :)",
						fbPost: "Преузимамо објаву. Молимо вас сачекајте :)",
						linkNotFound: "Линк за преузимање није пронађен",
						twPost: "Преузимамо објаву. Молимо вас сачекајте :)",
						privateAccountMessage: "Унели сте линк ка приватном налогу. Молимо, покушајте да користите линк ка јавном налогу.",
						noStoriesMessage: "Чини се да нема прича у последња 24 сата. Молимо покушајте поново касније.",
						noHighlightsMessage: "Нису пронађени нагласци. Молимо покушајте поново касније.",
						noPostsMessage: "Нема пронађених постова. Молимо покушајте поново касније.",
						noReelsMessage: "Нема пронађених reels. Молимо покушајте поново касније.",
						fileNotFound: "Датотека није пронађена",
						pageNotFound: "Страница није пронађена",
						pageWithoutFiles: "Ова страница не садржи датотеке",
						privatePage: "Ова страница је приватна",
						restrictedAccess: "Приступ овој страници је ограничен",
						captchaRequired: "Потребна је капча",
						mediaNotSupported: "Овај тип медија није подржан",
						albumsNotSupported: "Албуми нису подржани",
						liveUnableDownload: "Уживо снимци се не могу преузети",
						reedMore: "Прочитај више",
						seePost: "Погледај ову објаву"
					},
					sv: {
						...
						downloadFileReady: "Din fil är klar",
						downloadPage: "Detta är nedladdningssidan på vår webbplats. Vi lagrar inte dina data och vi värdar inte något innehåll på vår server.",
						downloadPageAnon: "Använd Anonyig för att ladda ner vilken video eller foto från Instagram som helst till din enhet - gratis, säkert, snabbt och anonymt.",
						errorDefault: "Något gick fel",
						errorLinkRequired: "@användarnamn eller länk krävs",
						errorLinkFormat: "Länkformatet är felaktigt",
						errorLinkNosupport: "Länken stöds inte",
						errorOutdateResult: "Resultaten är föråldrade. Prova din sökning igen",
						igUsername: "Vi laddar ner profilen. Vänta vänligen :)",
						igUsernameLink: "Vi laddar ner profilen. Vänta vänligen :)",
						igPost: "Vi laddar ner inlägget. Vänta vänligen :)",
						igReel: "Vi laddar ner reel. Vänta vänligen :)",
						igStory: "Vi laddar ner berättelsen. Vänta vänligen :)",
						igStories: "Vi laddar ner berättelserna. Vänta vänligen :)",
						igHighlightStories: "Vi laddar ner höjdpunkten. Vänta vänligen :)",
						igAvatar: "Vi laddar ner avataren. Vänta vänligen :)",
						fbPost: "Vi laddar ner inlägget. Vänta vänligen :)",
						linkNotFound: "Nedladdningslänken hittades inte",
						twPost: "Vi laddar ner inlägget. Vänta vänligen :)",
						privateAccountMessage: "Du har angett en länk till ett privat konto. Försök att använda en länk till ett offentligt konto.",
						noStoriesMessage: "Det verkar inte finnas några berättelser de senaste 24 timmarna. Försök igen senare.",
						noHighlightsMessage: "Inga höjdpunkter hittades. Försök igen senare.",
						noPostsMessage: "Inga inlägg hittades. Försök igen senare.",
						noReelsMessage: "Inga reels hittades. Försök igen senare.",
						fileNotFound: "Filen hittades inte",
						pageNotFound: "Sidan hittades inte",
						pageWithoutFiles: "Den här sidan innehåller inga filer",
						privatePage: "Den här sidan är privat",
						restrictedAccess: "Begränsad åtkomst till denna sida",
						captchaRequired: "Captcha krävs",
						mediaNotSupported: "Den här mediatypen stöds inte",
						albumsNotSupported: "Album stöds inte",
						liveUnableDownload: "Livevideor kan inte laddas ner",
						reedMore: "Läs mer",
						seePost: "Se det här inlägget"
					},
					th: {
						...
						btnDownloadOther: "ดาวน์โหลดอื่น ๆ",
						captchaLabel: "กรอกข้อความที่คุณเห็นด้านบน",
						captchaIncorrectText: "ข้อความไม่ถูกต้อง",
						downloadFileReady: "ไฟล์ของคุณพร้อมแล้ว",
						downloadPage: "นี่คือหน้าดาวน์โหลดบนเว็บไซต์ของเรา เราไม่จัดเก็บข้อมูลของคุณหรือโฮสต์เนื้อหาใด ๆ บนเซิร์ฟเวอร์ของเรา",
						downloadPageAnon: "ใช้ Anonyig เพื่อดาวน์โหลดวิดีโอหรือรูปภาพจาก Instagram ไปยังอุปกรณ์ของคุณได้ฟรี ปลอดภัย รวดเร็ว และไม่ระบุชื่อ",
						errorDefault: "เกิดข้อผิดพลาดบางอย่าง",
						errorLinkRequired: "ต้องระบุ @username หรือ ลิงก์",
						errorLinkFormat: "รูปแบบลิงก์ไม่ถูกต้อง",
						errorLinkNosupport: "ลิงก์ไม่รองรับ",
						errorOutdateResult: "ผลลัพธ์ล้าสมัยแล้ว กรุณาค้นหาอีกครั้ง",
						igUsername: "เรากำลังดาวน์โหลดโปรไฟล์ โปรดรอ :)",
						igUsernameLink: "เรากำลังดาวน์โหลดโปรไฟล์ โปรดรอ :)",
						igPost: "เรากำลังดาวน์โหลดโพสต์ โปรดรอ :)",
						igReel: "เรากำลังดาวน์โหลดรีล โปรดรอ :)",
						igStory: "เรากำลังดาวน์โหลดเรื่องราว โปรดรอ :)",
						igStories: "เรากำลังดาวน์โหลดเรื่องราว โปรดรอ :)",
						igHighlightStories: "เรากำลังดาวน์โหลดไฮไลต์ โปรดรอ :)",
						igAvatar: "เรากำลังดาวน์โหลดอวตาร โปรดรอ :)",
						fbPost: "เรากำลังดาวน์โหลดโพสต์ โปรดรอ :)",
						linkNotFound: "ไม่พบลิงก์ดาวน์โหลด",
						twPost: "เรากำลังดาวน์โหลดโพสต์ โปรดรอ :)",
						privateAccountMessage: "คุณได้ป้อนลิงก์ไปยังบัญชีส่วนตัว กรุณาลองใช้ลิงก์ไปยังบัญชีสาธารณะ",
						noStoriesMessage: "ดูเหมือนว่าจะไม่มีเรื่องราวใดในช่วง 24 ชั่วโมงที่ผ่านมา กรุณาลองใหม่อีกครั้งในภายหลัง",
						noHighlightsMessage: "ไม่พบเรื่องเด่น กรุณาลองใหม่อีกครั้งในภายหลัง",
						noPostsMessage: "ไม่พบบทความ กรุณาลองใหม่อีกครั้งในภายหลัง",
						noReelsMessage: "ไม่พบ reels กรุณาลองใหม่อีกครั้งในภายหลัง",
						fileNotFound: "ไม่พบไฟล์",
						pageNotFound: "ไม่พบหน้าเว็บ",
						pageWithoutFiles: "หน้านี้ไม่มีไฟล์",
						privatePage: "หน้านี้เป็นส่วนตัว",
						restrictedAccess: "การเข้าถึงหน้านี้ถูกจำกัด",
						captchaRequired: "ต้องการแคปช่า",
						mediaNotSupported: "ไม่รองรับสื่อประเภทนี้",
						albumsNotSupported: "อัลบั้มไม่ได้รับการสนับสนุน",
						liveUnableDownload: "ไม่สามารถดาวน์โหลดวิดีโอสดได้",
						reedMore: "อ่านเพิ่มเติม",
						seePost: "ดูโพสต์นี้"
					},
					tr: {
						...
						btnBack: "Geri dön",
						btnDownload: "İndir",
						btnDownloadOther: "Başka bir dosya indir",
						captchaLabel: "Yukarıda gördüğünüz metni girin",
						captchaIncorrectText: "Yanlış metin",
						downloadFileReady: "Dosyanız hazır",
						downloadPage: "Bu, web sitemizdeki indirme sayfasıdır. Verilerinizi saklamıyoruz veya sunucumuzda herhangi bir içerik barındırmıyoruz.",
						downloadPageAnon: "Herhangi bir Instagram videosunu veya fotoğrafını cihazınıza indirmek için Anonyig kullanın - ücretsiz, güvenli, hızlı ve anonim.",
						errorDefault: "Bir şeyler ters gitti",
						errorLinkRequired: "@kullanıcı adı veya bağlantı gerekli",
						errorLinkFormat: "Bağlantı formatı hatalı",
						errorLinkNosupport: "Bağlantı desteklenmiyor",
						errorOutdateResult: "Sonuçlar eski. Lütfen yeniden arama yapın",
						igUsername: "Profili indiriyoruz. Lütfen bekleyin :)",
						igUsernameLink: "Profili indiriyoruz. Lütfen bekleyin :)",
						igPost: "Gönderiyi indiriyoruz. Lütfen bekleyin :)",
						igReel: "Reel indiriliyor. Lütfen bekleyin :)",
						igStory: "Hikaye indiriliyor. Lütfen bekleyin :)",
						igStories: "Hikayeler indiriliyor. Lütfen bekleyin :)",
						igHighlightStories: "Öne çıkan hikaye indiriliyor. Lütfen bekleyin :)",
						igAvatar: "Avatar indiriliyor. Lütfen bekleyin :)",
						fbPost: "Gönderi indiriliyor. Lütfen bekleyin :)",
						linkNotFound: "İndirme bağlantısı bulunamadı",
						twPost: "Gönderi indiriliyor. Lütfen bekleyin :)",
						privateAccountMessage: "Bir özel hesap bağlantısı girdiniz. Lütfen bir genel hesap bağlantısını kullanmayı deneyin.",
						noStoriesMessage: "Son 24 saat içinde hiçbir hikaye görünmüyor. Lütfen daha sonra tekrar deneyin.",
						noHighlightsMessage: "Hiçbir öne çıkan içerik bulunamadı. Lütfen daha sonra tekrar deneyin.",
						noPostsMessage: "Hiçbir gönderi bulunamadı. Lütfen daha sonra tekrar deneyin.",
						noReelsMessage: "Hiçbir reel bulunamadı. Lütfen daha sonra tekrar deneyin.",
						fileNotFound: "Dosya bulunamadı",
						pageNotFound: "Sayfa bulunamadı",
						pageWithoutFiles: "Bu sayfa herhangi bir dosya içermiyor",
						privatePage: "Bu sayfa özel",
						restrictedAccess: "Bu sayfaya erişim kısıtlı",
						captchaRequired: "Captcha gerekli",
						mediaNotSupported: "Bu medya türü desteklenmiyor",
						albumsNotSupported: "Albümler desteklenmiyor",
						liveUnableDownload: "Canlı videolar indirilemez",
						reedMore: "Daha fazla oku",
						seePost: "Bu gönderiyi gör"
					},
					vi: {
						...
						btnDownloadOther: "Tải xuống cái khác",
						captchaLabel: "Nhập văn bản bạn thấy ở trên",
						captchaIncorrectText: "Văn bản không chính xác",
						downloadFileReady: "Tệp của bạn đã sẵn sàng",
						downloadPage: "Đây là trang tải xuống trên trang web của chúng tôi. Chúng tôi không lưu trữ dữ liệu của bạn hoặc lưu trữ bất kỳ nội dung nào trên máy chủ của mình.",
						downloadPageAnon: "Sử dụng Anonyig để tải xuống bất kỳ video hoặc ảnh nào từ Instagram về thiết bị của bạn - miễn phí, an toàn, nhanh chóng và ẩn danh.",
						errorDefault: "Đã xảy ra sự cố",
						errorLinkRequired: "Yêu cầu @tên người dùng hoặc liên kết",
						errorLinkFormat: "Định dạng liên kết không đúng",
						errorLinkNosupport: "Liên kết không được hỗ trợ",
						errorOutdateResult: "Kết quả đã lỗi thời. Vui lòng tìm kiếm lại",
						igUsername: "Chúng tôi đang tải xuống hồ sơ. Vui lòng đợi :)",
						igUsernameLink: "Chúng tôi đang tải xuống hồ sơ. Vui lòng đợi :)",
						igPost: "Chúng tôi đang tải xuống bài viết. Vui lòng đợi :)",
						igReel: "Chúng tôi đang tải xuống reel. Vui lòng đợi :)",
						igStory: "Chúng tôi đang tải xuống câu chuyện. Vui lòng đợi :)",
						igStories: "Chúng tôi đang tải xuống các câu chuyện. Vui lòng đợi :)",
						igHighlightStories: "Chúng tôi đang tải xuống câu chuyện nổi bật. Vui lòng đợi :)",
						igAvatar: "Chúng tôi đang tải xuống ảnh đại diện. Vui lòng đợi :)",
						fbPost: "Chúng tôi đang tải xuống bài viết. Vui lòng đợi :)",
						linkNotFound: "Không tìm thấy liên kết tải xuống",
						twPost: "Chúng tôi đang tải xuống bài viết. Vui lòng đợi :)",
						privateAccountMessage: "Bạn đã nhập liên kết đến tài khoản riêng tư. Vui lòng thử sử dụng liên kết đến tài khoản công khai.",
						noStoriesMessage: "Có vẻ như không có câu chuyện nào trong 24 giờ qua. Vui lòng thử lại sau.",
						noHighlightsMessage: "Không tìm thấy nội dung nổi bật. Vui lòng thử lại sau.",
						noPostsMessage: "Không tìm thấy bài đăng nào. Vui lòng thử lại sau.",
						noReelsMessage: "Không tìm thấy reel nào. Vui lòng thử lại sau.",
						fileNotFound: "Không tìm thấy tệp",
						pageNotFound: "Không tìm thấy trang",
						pageWithoutFiles: "Trang này không có tệp nào",
						privatePage: "Trang này là riêng tư",
						restrictedAccess: "Truy cập bị hạn chế vào trang này",
						captchaRequired: "Yêu cầu captcha",
						mediaNotSupported: "Loại phương tiện này không được hỗ trợ",
						albumsNotSupported: "Album không được hỗ trợ",
						liveUnableDownload: "Không thể tải video trực tiếp",
						reedMore: "Đọc thêm",
						seePost: "Xem bài viết này"
					},
					zh: {
						searchResult: "搜索结果",
						download: "下载",
						...
						btnBack: "返回",
						btnDownload: "下载",
						btnDownloadOther: "下载其他",
						captchaLabel: "输入您上面看到的文本",
						captchaIncorrectText: "文本不正确",
						downloadFileReady: "您的文件已准备好",
						downloadPage: "这是我们网站的下载页面。我们不会存储您的数据，也不会在我们的服务器上托管任何内容。",
						downloadPageAnon: "使用 Anonyig Instagram 下载器将任何 Instagram 视频或照片保存到您的设备中——免费、安全、快速且匿名。",
						errorDefault: "出现了问题",
						errorLinkRequired: "必须提供 @用户名 或链接",
						errorLinkFormat: "链接格式不正确",
						errorLinkNosupport: "不支持该链接",
						errorOutdateResult: "结果已经过时。 再试一次搜索",
						igUsername: "我们正在下载个人资料。请稍候 :)",
						igUsernameLink: "我们正在下载个人资料。请稍候 :)",
						igPost: "我们正在下载帖子。请稍候 :)",
						igReel: "我们正在下载 reel。请稍候 :)",
						igStory: "我们正在下载故事。请稍候 :)",
						igStories: "我们正在下载故事。请稍候 :)",
						igHighlightStories: "我们正在下载精选故事。请稍候 :)",
						igAvatar: "我们正在下载头像。请稍候 :)",
						fbPost: "我们正在下载帖子。请稍候 :)",
						linkNotFound: "未找到下载链接",
						twPost: "我们正在下载帖子。请稍候 :)",
						privateAccountMessage: "您输入了一个私人账户的链接。请尝试使用公共账户的链接。",
						noStoriesMessage: "过去 24 小时内似乎没有任何故事。请稍后再试。",
						noHighlightsMessage: "未找到任何亮点。请稍后再试。",
						noPostsMessage: "未找到任何帖子。请稍后再试。",
						noReelsMessage: "未找到任何 reels。请稍后再试。",
						fileNotFound: "文件未找到",
						pageNotFound: "页面未找到",
						pageWithoutFiles: "此页面不包含任何文件",
						privatePage: "此页面为私有页面",
						restrictedAccess: "此页面的访问受限",
						captchaRequired: "需要验证码",
						mediaNotSupported: "不支持此媒体类型",
						albumsNotSupported: "不支持相册",
						liveUnableDownload: "无法下载直播视频",
						reedMore: "阅读更多",
						seePost: "查看此帖子"
					}
				};
